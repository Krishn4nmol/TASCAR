# run_lstm_sac_seed456_fixed.py
# Trains LSTM+SAC seed 123
# Saves to trained_model_lstm_sac_seed456/

import config
config.RANDOM_SEED    = 456
config.TASCAR_MODEL_PATH = "trained_model_lstm_sac_seed456/"
config.TASCAR_RESULTS    = "results_lstm_sac_seed456/"
...
MODEL_PATH   = "trained_model_lstm_sac_seed456/"
RESULTS_PATH = "results_lstm_sac_seed456/"
...
for ep in range(20):
    ...
    enc = lstm(torch.FloatTensor(seq).unsqueeze(0))
