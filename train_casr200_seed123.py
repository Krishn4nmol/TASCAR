# train_casr200_seed123.py
# Retrains CASR for 200 episodes with seed=123
...
# Save path for seed-123 CASR-200 retrain
CASR_500_PATH = "trained_model_casr200_seed123/"
...
# PPO + single state!
# Fixed theta = 0.8!
# 200 episodes, seed 123!
# ─────────────────────────────────────────

def train_casr_500():
    """
    Train CASR for 200 episodes, seed 123!
    ...
    print(f"\nCASR-200 (seed 123) Configuration:")
    ...
    print(
        "\nStarting CASR-200 (seed 123) training...")
    print("=" * 50)
    ...
    log_path = (
        ABLATION_RESULTS +
        'casr200_seed123_logs.json')
    with open(log_path, 'w') as f:
        json.dump(logs, f, indent=2)

    print("\n" + "=" * 50)
    print("CASR-200 (seed 123) Training Complete!")
    print("=" * 50)
    print(
        f"Best reward:    "
        f"{best_reward:.4f}")
...
def quick_check():
    """
    Quick check: CASR-200 (seed 123) CSR
    on Common workload.
    """
    ...
    print("\n" + "=" * 50)
    print("Quick Check: CASR-200 seed 123")
    print("=" * 50)

    QUICK_CHECK_SEED = 123
...
if __name__ == "__main__":
    print("=" * 50)
    print("CASR-200 Episode Training")
    print("Multi-seed ablation: seed 123")
