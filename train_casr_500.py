# train_casr_500.py
# Retrains CASR for 500 episodes
# To test if equal budget
# changes results!
# If CASR 500 beats TASCAR:
# Keep CASR 200 in paper!
# If CASR 500 loses:
# Architecture wins! Strong paper!
...
# Save path for 500 episode CASR
CASR_500_PATH = "trained_model_casr_500/"
...
def train_casr_500():
    ...
    print("CASR 500 Episode Training!")
    print(
        f"Seed: {RANDOM_SEED}")
    print(
    ...
    print(
        "Only 500 episodes instead of 200!")
    ...
    print("\n" + "=" * 50)
    print("CASR 500 Training Complete!")
    print("=" * 50)
    print(
        f"Best reward:    "
        f"{best_reward:.4f}")
    ...
    print(
        f"\nNow run check to compare"
        f" with TASCAR!")
    print(
        f"python check_checkpoint.py")
...
def quick_check():
    """
    Quick check: does CASR 500
    beat TASCAR on Common workload?
    """
    ...
    print(
        f"TASCAR CSR:     72.101%")
    print(
        f"CASR 200 CSR:   89.105%")

    if csr < 72.101:
        print(
            f"\nCASR 500 BEATS TASCAR! ⚠️")
        print(
            f"Keep CASR 200 in paper!")
        print(
            f"Training budget matters!")
    elif csr < 89.105:
        print(
            f"\nCASR 500 beats CASR 200!")
        print(
            f"But TASCAR still wins! ✅")
        print(
            f"Architecture advantage "
            f"confirmed!")
    else:
        print(
            f"\nCASR 500 same as CASR 200!")
        print(
            f"Extra training not helping!")
        print(
            f"TASCAR architecture wins! ✅")
